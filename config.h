...
static Key keys[] = {
	...
	{ MODKEY|ControlMask, XK_b,      spawn,          SHCMD("$TERMINAL -e $EDITOR $HOME/.local/share/bookmarks") },
	{ MODKEY|ShiftMask,   XK_b,      togglebar,      {0} },
	{ MODKEY,             XK_c,      togglescratch,  {.ui = 2 } },
	{ MODKEY|ShiftMask,   XK_c,      spawn,          SHCMD("surf $HOME/hell/dox/mydox/my-weekly-program2021.html >/dev/null 2>&1") },
	{ MODKEY|ControlMask, XK_c,      spawn,          SHCMD("$TERMINAL -e $EDITOR $HOME/hell/dox/mydox/my-weekly-program2021.html") },
	...
	{ MODKEY|ControlMask, XK_s,      spawn,          SHCMD("killall dwmblocks && setsid dwmblocks") },
	...
	{ 0,                  XK_Print,  spawn,          SHCMD("maim ~/media/pix/screenshots/pic-full-$(date '+%y%m%d-%H%M-%S').png && notify-send \"Full screen screenshot taken\"&") },
